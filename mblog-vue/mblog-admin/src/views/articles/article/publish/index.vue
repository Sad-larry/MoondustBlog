<template>
    <el-card class="main-card">
        ...
        <div class="article-title-container">
            ...
            <el-button type="danger" size="medium" class="save-btn" @click="saveArticleDraft" v-if="article.id == null">
                保存草稿 </el-button>
        ...
        <editor ref="md" v-model="article.contentMd" @imgAdd="uploadImg" style="height: calc(100vh - 260px)" />
        <!-- 添加文章对话框 -->
        <el-dialog :visible.sync="addOrEdit" width="40%" top="3vh">
            ...
            <el-form label-width="80px" size="medium" :model="article">
                ...
                <el-form-item label="文章标签">
                    <el-tag v-for="(item, index) of article.tagNames" :key="index" style="margin: 0 1rem 0 0"
                ...
                <el-form-item label="上传封面">
                    <el-upload class="upload-cover" drag action="/api/admin/articles/images" multiple :headers="headers"
                        :before-upload="beforeUpload" :on-success="uploadCover">
                        <i class="el-icon-upload" v-if="article.summary == ''" />
                        <div class="el-upload__text" v-if="article.summary == ''">将文件拖到此处，或<em>点击上传</em></div>
                        <img v-else :src="article.summary" width="360px" height="180px" />
                    </el-upload>
                </el-form-item>
                ...
                <el-form-item label="推荐">
                    <el-switch v-model="article.isFeatured" active-color="#13ce66" inactive-color="#F4F4F5"
...
export default {
    ...
    methods: {
        ...
        uploadCover(response) {
            this.article.summary = response.data
        },
        beforeUpload(file) {
