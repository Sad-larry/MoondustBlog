  ...
  <div class="app-container">
    <el-form v-show="showSearch" :inline="true" ref="form" :model="queryParams" label-width="68px">
      ...
      <el-form-item label="任务组名">
        <el-select size="small" @change='handleFind' clearable style="margin-left: 5px" v-model="queryParams.jobGroup"
          placeholder="请选择组名">
          <el-option v-for="item in jobDictList" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="执行状态">
        <el-select size="small" @change='handleFind' clearable style="margin-left: 5px" v-model="queryParams.status"
          placeholder="请选择任务状态">
      ...
      <el-form-item label="执行时间">
        <el-date-picker size="small" v-model="dateRange" type="daterange" range-separator="至" start-placeholder="开始日期"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button :disabled="!ids.length" type="danger" plain icon="el-icon-delete" size="mini"
          @click="handleDelete">批量删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" @click="handleClean">清空
        </el-button>
      </el-col>
      <el-col :span="1.5">
    ...
    <el-table v-loading="loading" :data="jobLogList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="任务组名" align="center" prop="jobGroup" :show-overflow-tooltip="true">
        <template slot-scope="scope" v-for="(item, index) in jobDictList">
          <el-tag :type="item.style" v-if="scope.row.jobGroup === item.value" :key="index">
            {{ item.label }}
          </el-tag>
        </template>
      </el-table-column>
