  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          icon="el-icon-delete"
          size="mini"
          v-hasPermi="['system:friendlink:delete']"
          @click="handleDelete"
        >删除</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="linkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" prop="status" label="状态">
        <template slot-scope="scope">
          <span>
            <el-tag :type="statusTypes[scope.row.status]">{{ statusOptions[scope.row.status] }}</el-tag>
          </span>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作" width="300">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['system:friendlink:pass']"
          >审核通过</el-button>
          <el-button
            ...
            v-hasPermi="['system:friendlink:top']"
          >置顶</el-button>
          <el-button
            size="mini"
            type="warning"
