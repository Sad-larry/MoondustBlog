                    ...
                    <el-row :gutter="12">
                        <el-col :span="6">
                            <el-form-item label="网站头像">
                                <el-upload class="avatar-uploader1" action ref="upload" :show-file-list="false"
                                    ...
                                    <img style="width: 100px;height: 100px" v-if="form.logo" :src="form.logo"
                                        class="avatar1">
                        ...
                        <el-col :span="6">
                            <el-form-item label="游客头像" prop="touristAvatar">
                                <el-upload class="avatar-uploader1" action ref="upload" :show-file-list="false"
                                    :before-upload="uploadBefore" :http-request="touristUpload">
                                    <img style="width: 100px;height: 100px" v-if="form.touristAvatar"
                                        :src="form.touristAvatar" class="avatar1">
                                    <i v-else class="el-icon-plus avatar-uploader-icon1"></i>
                                </el-upload>
                            </el-form-item>
                        </el-col>
            ...
            <el-tab-pane>
                ...
                <el-form style="margin-left: 20px;" label-position="left" :model="form" label-width="80px" ref="from">
                    <el-form-item label="作者头像">
                        <el-upload class="avatar-uploader1" action ref="upload" :show-file-list="false"
                            :before-upload="uploadBefore" :http-request="authorUpload">
                            <img style="width: 100px;height: 100px" v-if="form.authorAvatar" :src="form.authorAvatar"
                                class="avatar1">
                            <i v-else class="el-icon-plus avatar-uploader-icon1"></i>
                        </el-upload>
                    </el-form-item>
                ...
                <el-form style="margin-left: 20px;" label-position="left" :model="form" label-width="90px" ref="from">
                        ...
                        <el-col :span="5">
                            <el-form-item label="支付宝">
                                <el-upload class="avatar-uploader1" action ref="upload" :show-file-list="false"
                                    ...
                                    <img style="width: 100px;height: 100px" v-if="form.aliPay" :src="form.aliPay"
                                        class="avatar1" alt="">
                                    <i v-else class="el-icon-plus avatar-uploader-icon1"></i>
                                </el-upload>
                            </el-form-item>
                        ...
                        <el-col :span="5">
                            <el-form-item label="微信">
                                <el-upload class="avatar-uploader1" action ref="upload" :show-file-list="false"
                                    ...
                                    <img style="width: 100px;height: 100px" v-if="form.weixinPay" :src="form.weixinPay"
                                        class="avatar1" alt="">
                                    <i v-else class="el-icon-plus avatar-uploader-icon1"></i>
                                </el-upload>
                            </el-form-item>
                    ...
                    <el-row :gutter="24">
                        <el-form-item label="网站评论">
                            <el-radio v-for="item in openDictList" :key="item.id" v-model="form.openComment"
                                :label="Number.parseInt(item.value)" border size="medium">{{ item.label }}
                            </el-radio>
                        </el-form-item>
                    </el-row>
                    <el-row :gutter="24">
                        <el-form-item label="网站打赏">
                            <el-radio v-for="item in openDictList" :key="item.id" v-model="form.openAdmiration"
                                :label="Number.parseInt(item.value)" border size="medium">{{ item.label }}
                            </el-radio>
                        </el-form-item>
                    </el-row>
