...
<script>
import { listWebPage, delWebPage, addWebPage, updateWebPage } from "@/api/system/webPage";
    ...
    methods: {
        ...
        submit() {
            this.$refs['dataForm'].validate((valid) => {
                if (valid) {
                    if (this.isEditForm) {
                        updateWebPage(this.pageForum).then(res => {
                        ...
                        addWebPage(this.pageForum).then(res => {
