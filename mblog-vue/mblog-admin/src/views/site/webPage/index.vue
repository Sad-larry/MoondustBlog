    ...
    <el-card class="main-card">
      <div>
        <el-button
          ...
          v-hasPermi="['system:webPage:add']"
        >新建页面</el-button>
      </div>
      <!-- 相册列表 -->
      <el-row class="page-container" :gutter="12" v-loading="loading">
        <!-- 空状态 -->
        <el-empty v-if="pageList.length === 0" description="暂无图片"></el-empty>
            ...
            <div class="page-opreation">
              <el-dropdown @command="handleCommand">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item :command="'update' + JSON.stringify(item)" v-hasPermi="['system:webPage:update']">
                    <i class="el-icon-edit" />编辑
                  </el-dropdown-item>
                  <el-dropdown-item :command="'delete' + item.id" v-hasPermi="['system:webPage:delete']">
