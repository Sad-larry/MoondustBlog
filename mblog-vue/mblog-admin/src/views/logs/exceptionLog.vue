<template>
    <div class="app-container">
        ...
        <el-table border v-loading="loading" :data="exceptionLogList" @selection-change="handleSelectionChange"
            style="width: 100%;">
            <el-table-column align="center" type="selection" width="55">
            </el-table-column>
            <el-table-column prop="exceptionMessage" :show-overflow-tooltip="true" align="center" width="270"
                label="异常内容" />
            ...
            <el-table-column label="操作" align="center" width="80" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <el-button size="mini" type="text" icon="el-icon-more" @click="logDetail(scope.row)">详情</el-button>
                </template>
            </el-table-column>
        </el-table>
