<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="父模块id" prop="pid">
        <el-input
    ...
    <el-table v-loading="loading" :data="resourceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="权限路径" align="center" prop="url" />
      <el-table-column label="请求方式" align="center" prop="requestMethod" />
      <el-table-column label="父模块id" align="center" prop="pid" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="权限路径" prop="url">
          <el-input v-model="form.url" placeholder="请输入权限路径" />
        </el-form-item>
        <el-form-item label="请求方式" prop="requestMethod">
          <el-input v-model="form.requestMethod" placeholder="请输入请求方式" />
        </el-form-item>
        <el-form-item label="父模块id" prop="pid">
          <el-input v-model="form.pid" placeholder="请输入父模块id" />
        </el-form-item>
      </el-form>
