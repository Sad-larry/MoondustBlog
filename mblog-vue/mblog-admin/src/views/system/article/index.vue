<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否允许评论(0否,1是)" prop="isComment">
        <el-input
          v-model="queryParams.isComment"
          placeholder="请输入是否允许评论(0否,1是)"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="articleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文章状态(0草稿,1发布,2待删除)" align="center" prop="status" />
      <el-table-column label="浏览量" align="center" prop="viewCount" />
      <el-table-column label="是否允许评论(0否,1是)" align="center" prop="isComment" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否允许评论(0否,1是)" prop="isComment">
          <el-input v-model="form.isComment" placeholder="请输入是否允许评论(0否,1是)" />
        </el-form-item>
        <el-form-item label="评论数" prop="commentCount">
