<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="imageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="图片地址" align="center" prop="imageSrc" />
      <el-table-column label="图片状态(0停用,1正常)" align="center" prop="status" />
  ...
  data() {
    return {
      ...
      rules: {
        ...
        status: [
          { required: true, message: "图片状态(0停用,1正常)不能为空", trigger: "blur" }
        ],
        createTime: [
