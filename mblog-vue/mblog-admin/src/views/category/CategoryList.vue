    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
            ...
            <el-form-item label="分类名" prop="categoryName">
                <el-input v-model="queryParams.categoryName" placeholder="请输入分类名" clearable
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item label="分类描述" prop="description">
                <el-input v-model="queryParams.description" placeholder="请输入分类描述" clearable
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple"
                    @click="handleDelete" v-hasPermi="['system:category:remove']">删除</el-button>
            </el-col>
            <el-col :span="1.5">
        ...
        <el-table v-loading="loading" :data="categoryList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="分类状态(1正常,0停用)" align="center" prop="status" />
    ...
    data() {
        return {
            ...
            rules: {
                ...
                status: [
                    { required: true, message: "分类状态(1正常,0停用)不能为空", trigger: "blur" }
                ],
                createTime: [
