        ...
        <div class="blog-wrapper">
          <v-card class="animated zoomIn blog-card mt-5">
            <div class="author-wrapper">
              ...
              <div style="font-size: 1.375rem">{{ blogInfo.webSite.author }}</div>
              <div style="font-size: 0.875rem;">{{ blogInfo.webSite.authorInfo }}</div>
            </div>
            <!-- 博客信息 -->
            <div class="blog-info-wrapper">
              <div class="blog-info-data">
                <router-link to="/archives">
                  ...
                  <div style="font-size: 1.25rem">{{ blogInfo.count.articleCount }}</div>
                </router-link>
              </div>
              <div class="blog-info-data">
                <router-link to="/categories">
                  <div style="font-size: 0.875rem">分类</div>
                  <div style="font-size: 1.25rem">{{ blogInfo.count.categoryCount }}</div>
                </router-link>
              </div>
              <div class="blog-info-data">
                <router-link to="/tags">
            ...
            <a class="collection-btn" @click="tip = true">
              <v-icon color="#fff" size="18" class="mr-1">mdi-bookmark</v-icon>加入书签
            </a>
          </v-card>
          <!-- 公告 -->
          <v-card>
          ...
          <v-card v-if="isCouldShowSocial()" class="blog-card animated zoomIn mt-5 big">
            <div class="web-info-title">
              <v-icon size="18">mdi-account</v-icon>关注我们
            </div>
            <div class="guanzhu" id="follow-us" ref="follow">
              <ul>
                <li v-if="isShowSocial(1)" class="email">
                  <a href="javascript:void(0);">{{ blogInfo.webSite.email }}</a>
                </li>
                <li v-if="isShowSocial(2)" class="qq">
                  <a
                    :href="'tencent://AddContact/?fromId=50&fromSubId=1&subcmd=all&uin=' + blogInfo.webSite.qqNumber"
                    target="_blank"
                  >{{ blogInfo.webSite.qqNumber }}</a>
                </li>
                <li v-if="isShowSocial(3)" class="github">
                  <a :href="blogInfo.webSite.github" target="_blank">
                    {{
                    blogInfo.webSite.github
                    }}
                  </a>
                </li>
                <li v-if="isShowSocial(4)" class="gitee">
                  <a :href="blogInfo.webSite.gitee" target="_blank">
                    {{
          ...
          <v-card class="blog-card animated zoomIn mt-5">
            <div class="web-info-title">
              <v-icon size="18">mdi-chart-line</v-icon>网站资讯
            </div>
            <div class="web-info">
  ...
  computed: {
    ...
    isShowSocial() {
      return function (social) {
        return (
          this.$store.state.blogInfo.webSite.showList.indexOf(social) != -1
        );
      };
    },
    cover() {
