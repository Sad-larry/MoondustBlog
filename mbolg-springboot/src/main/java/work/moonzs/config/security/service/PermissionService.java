package work.moonzs.config.security.service;
...
public class PermissionService {
    ...
    public boolean hasRole(String role) {
        ...
        LoginUser loginUser = SecurityUtil.getLoginUser();
        if (ObjUtil.isNull(loginUser) || StrUtil.isEmpty(loginUser.getRole())) {
            return false;
        }
        String roleKey = loginUser.getRole();
        return SUPER_ADMIN.equals(roleKey) || roleKey.equals(StrUtil.trim(role));
    }
